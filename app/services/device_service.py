...
class DeviceService():
    ...
    @with_uow
    async def get_diveces_by_serial_numbers(self, sr_numbers: list[str] = []) -> list[DeviceGET]:
        devices: Sequence[Device] = await self.uow.device_repo.get_diveces_by_serial_numbers(sr_numbers)
