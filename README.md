...
uv run celery -A app.celery.celery_app call app.celery.tasks.data.tasks.schedule_sync_history_data --kwargs='{"tag_title": "EnergyActiveForward30Min", "time_range": ["2025-11-10T00:00:00", "2028-09-10T20:08:00"], "time_partition": "1month"}'
